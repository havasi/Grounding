...
def deepColorTokenizeHelper(text, tokenizers, names, maxdepth, bgcolor):
    ...
    if maxdepth == 0:
        ...
        return {'color':HTMLColor(transcolor), 'colored':(howcolorful > 0 and not stopword), 'bordercolor': HTMLColor(color), names[0]:[text], 'fontcolor':fontcolor}
    else:
        textcolor = {}
