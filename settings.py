...
from csc.django_settings.__init__ import *
import os
...
SECRET_KEY = '&7ri#3f&6#7fd@6&s6jx7=lg^17&vptdn(p&1^y_m0pu^t7%k&'
...
TEMPLATE_DIRS = (
    ...
    #'/home/justin/csc/conceptnet/csc/concepttools/colorizer/templates',
    os.path.join(SITE_ROOT, 'colorizer/templates')
)
